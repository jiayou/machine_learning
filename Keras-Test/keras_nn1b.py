...
ADAPTION of Keras v1.1.1 in WinPython (from v2.0.2, Anaconda) 
...
model = Sequential()
model.add(Dense(input_dim=784, output_dim=64))
...
hist = model.fit(X_train, Y_train, shuffle=True, validation_split=0.2, batch_size=200)
